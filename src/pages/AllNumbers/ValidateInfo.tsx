              ...
              <div className="col-span-1 flex items-center">
                <p
                  className={`text-sm px-4 py-2 rounded ${
                    number?.valid_number ? 'bg-green text-white' : 'bg-red-600 text-white'
                  } dark:text-white`}
                >
...
<div className="col-span-6 xl:col-span-4 fixed top-0 right-0 mt-40 mr-8 w-1/4">
  <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
      ...
      <h3 className="text-sm text-black dark:text-white mb-5">Caution!! Always Use a VPN for researches.</h3>


      <div className='mb-4'>
        <h3 className="font-bold text-black dark:text-white mb-1">Info Finders</h3>
        <a href='https://www.fastpeoplesearch.com/' target='_blank'><p>https://www.fastpeoplesearch.com/</p></a>
        <a href='https://www.usphonebook.com/' target='_blank'><p >https://www.usphonebook.com/</p></a>
        <a href='https://castrickclues.com/' target='_blank'><p >https://castrickclues.com/</p></a>
        <a href='https://rocketreach.co/' target='_blank'><p >https://rocketreach.co/</p></a>
        <a href='https://epieos.com/' target='_blank'><p  className='mb-4'>https://epieos.com/</p></a>
        
        <span className='text-xs text-green'>Search Whatsapp</span>
        <a href='https://osint.rocks/' target='_blank'><p className=''>https://osint.rocks/</p></a> 
      </div>
      ...
      <div className='mb-4'>
        <h3 className="font-bold text-black dark:text-white mb-1">Social Finders</h3>
        <a href='https://instantusername.com/' target='_blank'><p>https://instantusername.com/</p></a>
        <span className='text-xs text-green'>Best on mobile</span>

        
        <a href='https://whatsmyname.app/' target='_blank'><p>https://whatsmyname.app/</p></a>
      </div>


      <div className='mb-4'>
        <h3 className="font-bold text-black dark:text-white mb-1">Telegram Bot Finders</h3>
        <a href='https://t.me/UniversalSearchEasyBot' target='_blank'><p>https://t.me/UniversalSearchEasyBot</p></a>

        
        <a href='https://t.me/anotherLeakOSINTbot' target='_blank'><p>https://t.me/anotherLeakOSINTbot</p></a>
      </div>


      <div className='mb-4'>
        <h3 className="font-bold text-black dark:text-white mb-1">Face Finders</h3>

        <a href='https://avatarapi.com/' target='_blank'><p>https://avatarapi.com/</p></a>
      </div>

...
const PhoneNumberCSVGenerator = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `${baseUrl}api/phone-generator/download-numbers/?user_id=${userID}&carrier=${carrier}&code=${code}`,
        {
          headers: {
  ...
  }, [baseUrl, userID, userToken, carrier, code]);

  useEffect(() => {
    
      fetchData();
    
  }, [carrier, code, fetchData]);
  ...
  return (
    <>
      <div className="mx-auto max-w-270">
        <Breadcrumb pageName="Generate Numbers CSV
" />
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
          <h3 className="font-medium text-black dark:text-white">Generate from my account</h3>
        </div>
        ...
        <div className="p-7">
            ...
            <div className="mb-5.5">
              ...
              <div className="grid grid-cols-2 gap-5 justify-center ">
                <div className="">
                  <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="carrier">
                    Select Carrier
                  </label>
                  <select
  id="carrier"
...
>
  ...
  <option value="CarrierA" className="hover:bg-graydark dark:hover:bg-graydark">Carrier A</option>
  <option value="CarrierB" className="hover:bg-graydark dark:hover:bg-graydark">Carrier B</option>
  <option value="CarrierC" className="hover:bg-graydark dark:hover:bg-graydark">Carrier C</option>
</select>
                ...
                <div className="">
                  <label className="mb-3 block text-sm font-medium text-black dark:text-white" htmlFor="areaCode">
                    Area Code
                  </label>
                  <input
                    type="text"
              ...
              {loading ? (
                ...
                >
                  Download CSV
                     ...
                     {phoneList.length > 0 && (
            <div className="mt-6">
              <h4 className="text-xl font-semibold text-black dark:text-white">Phone Numbers</h4>
              <ul className="mt-4 space-y-2">
                {phoneList.map((phone, index) => (
                  <li key={index} className="flex justify-between p-3 border border-gray-300 dark:border-gray-700 rounded-md">
                    <span>{phone}</span>
                  </li>
                ))}
              </ul>

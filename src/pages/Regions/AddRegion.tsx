...
const AddRegion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (regionName === '') {
      setInputError('Region name required.');
      return;
    }
    ...
    try {
      ...
      navigate('/all-regions'); // Navigate to success page
    } catch (error) {
      ...
      if (error.message === 'Errors' && error.errors) {
        ...
        setInputError('Failed to add region');
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="grid grid-cols-5 gap-8">
          ...
          <div className="col-span-5 xl:col-span-2">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
                <h3 className="font-medium text-black dark:text-white">
                  This information can only be updated by the super admin.
                </h3>
              </div>
            </div>
          </div>

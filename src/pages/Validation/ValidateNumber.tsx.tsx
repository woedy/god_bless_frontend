    ...
    <>
      ...
      >
        <div className="col-span-1 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <p className="text-sm text-black dark:text-white">
              {validationResponse?.country?.prefix ? validationResponse?.country?.prefix : '-'}
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <p className="text-sm text-black dark:text-white">
              {validationResponse?.phone ? validationResponse.phone : '-'}
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 flex items-center">
  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
    <p className={`text-sm px-4 py-2 rounded ${validationResponse?.valid ? 'bg-green text-white' : 'bg-red-600 text-white'} dark:text-white`}>
      {validationResponse?.valid ? 'Valid' : 'Invalid'}
        ...
        <div className="col-span-1 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <p className="text-sm text-black dark:text-white">
              {validationResponse?.carrier ? validationResponse?.carrier : '-'}
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <p className="text-sm text-black dark:text-white">
              {validationResponse?.location ? validationResponse.location : '-'}
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <p className="text-sm text-black dark:text-white">
              {validationResponse?.country?.name ? validationResponse?.country?.name : '-'}
            </p>
          </div>
        </div>
